...
* Configuration files, where are located the ARToolKit Native Libraries and the camera configuration file. Download it [here]({{site.github.url}}/downloads/config_files.zip) <a href="{{site.github.url}}/downloads/config_files.zip" class="icon fa-download"></a>
